...
╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝ ╚═╝  ╚═══╝╚═╝╚═╝  ╚═╝ GEN V2
        ...
        self.slowType("Made by: Aidan Tahmasbi and Aidanman14", .02) # Print who developed the code
        print()
        self.slowType("Free Discord Nitro Generator, Now Implemented Into TESS OS", .02)
...
Results:
 ...
 Valid Codes: {', '.join(valid )}""") # Give a report of the results of the check
        ...
        input("\nSuccesfully Genertated Nitro Codes! Press Enter 5 times to close the program.") # Tell the user the program finished
