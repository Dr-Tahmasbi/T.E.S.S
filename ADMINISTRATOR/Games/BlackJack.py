...
if s == 0:
    f2 = open("wins.txt", "w")
mode = 0
names = ["Dave", "Ben", "Lewis", "Cameron", "Theresa", "Johnson", "Jeff", "Matilda", "Fraser", "Jimmy", "Bob", "Kim", "Karl", "Darren", "Guy", "John", "Kevin", "Liam", "Oliver", "Olivia", "Emma", "Charlotte", "Amelia", "Charlie", "Charles", "Blake", "Joe", "Jon", "Jack", "Jemma", "Jermima", "Elijah", "Elliot", "Mayonnaise", "Helicopter", "Twitch", "Arse", "Kim Jong Un", "Donald Trump", "Shahzaman", "Chris Wooller", "Rocky", "Jibbert", "Boris", "Kier Starmer", "Scott", "Scotty", "Michael", "The Twitter Bird", "Lorraine", "Kelly", "Lorraine Kelly", "Davina", "Devida", "McCall", "Davina McCall", "Nuts", "Square", "Table", "Shaun", "Sean", "Shaun Connery", "Callum", "Benjamin", "Josh", "Bell", "Jess", "Izzy", "Isabelle", "Jeffery", "Geoff", "Geoffery", "Lorraine Kelly", "Nons", "Gary Glitter", "Toby Maguire", "Tom Holland", "Social Credit Guy" , "Triangle", "Pea", "Blob", "3D Square", "Dining Table", "Office Chair", "Kelly", "Lorraine", "Lorraine", "Kelly", "Democracy", "Nigel", "Farage", "Nigel Farage", "Brexit", "Brexit Means Brexit", "Kirby", "Mario", "Sonic", "Samus", "Link", "Zelda", "TikTok", "Tie", "Ashley", "Hello", "Anorexia", "Eat", "Clap", "Meals", "Windows XP", "2D Rectangle",  "Africa", "Jesus", "Jib Jib", "Far far away", "Star Wars", "Steven Spielburg", "God", "Theodore", "Name", "Surname", "Epic Chad Gamer", "Gigachad", "Lesser Chad", "Money", "Brexit MEANS Brexit", "Fudge", "What", "The", "Fudge", "NT", "Spacebar", "Clickety Clack", "File", "Nicely", "Formatted", "Code", "Floor", "Piano", "Cable", "GOD OF THE UNIVERSE", "Thanos", "Iron Man", "Thor", "Trees", "Tree", "Windows 8", "Windows 11 Is Also Bad", "Nigel Farage Hates Foreigners", "Astelea", "Osu!", "Poggers", "Peppy", "RobTop Games", "RubRub", "Sad", "Tairitsu", "Bob the Minion", "GrimPixelZ", "Xytrophico", "TriTech", "949", "Nintendo", "The Law", "Isaac Newton", "GCSE English Literature Paper 2", "Random kid", "Bingo", "Jonah", "Struthers", "The Craw", "The Ultimate Craw"]
...
░╚════╝░╚═╝░░╚═╝░╚════╝░╚═╝░░╚═╝{reset}''')
print(" ")
print(f"{RED}Blackjack For T.E.S.S OS v1701{reset}")
print(" ")
typeb("Please answer with NUMBERS ONLY - (1/2 for stand/hit, any number for bets.)", colorama.Fore.LIGHTRED_EX, True)
time.sleep(0.7)
typeb(f"By {RED}Aidan Tahmasbi, TriTechX and Xytrophico{reset}", reset, True)
typeb(f"{RED}Balance:{reset} £{money}", colorama.Fore.LIGHTCYAN_EX, True)
                    ...
                    while atotal < 21 and ptotal < 21:
                        ...
                        if ptotal > 21:
                            ...
                            if atotal != range(random.randint(14,18),20) and atotal != 21 and atotal < 21:
                                ...
                                break
                            elif atotal == range(random.randint(14,18),20) or atotal == 21 or atotal > 21:
                                if atotal == 21:
