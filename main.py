...
#Based off MS-DOS
#VISUAL STUDIO RELEASE ONLY (FOR NT SYSTEMS)
#-------------------------------------------------------------------------------------------------------------------
# Librarys
import webbrowser
import shutil
...
def system_status():
  ...
  print("T.E.S.S OS v1701 STABLE")
  print("DOS Based OS")
  print("Visual Studio Release")
#------------------------------------------------------------------------------------------------------------------
#Internet Speed Test
...
def version():
    ...
    print("Tahmasbi Industries - Electromagnetic - Supercomputer - System")
    print("T.E.S.S OS v1701 STABLE")
    print("DOS Based Operating System")
    print("Visual Studio Release")
...
def command_help(message_alert):
    ...
    print(f"{RED}Press [CTRL][C] on the terminal to shut down T.E.S.S.{reset}")
    print(" ")
    print("Commands:")
    print(" ")
...
os.system("cls")
print(LOGO)
print(f"Welcome To {RED}T.E.S.S OS{reset} v1701 STABLE.")
time.sleep(5)
os.system("cls")
#-------------------------------------------------------------------------------------------------------------------
#Username And Password
if userRunner != "aidan" or userRunner != "sy252556":
  if keyStr != "":
...
if userRunner != "aidan" or userRunner != "sy252556":
  ...
  while not validionormous:
      ...
      try:
          while valid == False:
              slowType("T.E.S.S OS v1701 STABLE", .02)
...
try:
    ...
    print("----------")
    slowType("Version: " + RED + str("T.E.S.S OS, Version 1701 STABLE, Visual Studio Release, DOS Based OS") + reset, .02)
    print("----------")
    print(" ")
    ...
    while True:
        ...
        if currentCommand == ("help"):
            ...
            print("----------")
            print("Version: " + RED + str("TESS OS, Version 1701 STABLE, Visual Studio Release, DOS Based OS") + reset)
            print("----------")
            print(" ")
    ...
    print(" ")
    time.sleep(2)
    slowType("Spinning Down Disk Handlers...", .02)
    print(" ")
    time.sleep(2)
    print("Done!")
    print(" ")
